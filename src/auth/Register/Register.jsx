    ...
    return (
        <div className='row justify-content-around'>
            <div className='col-md-5'>
                <img src="/signup-image.jpg" className='w-100' alt="" />
            </div>
            <div className='col-md-5 text-start'>
                ...
                <Form onSubmit={formik.handleSubmit}>
                    <Form.Group className='mb-3' controlId='Name'>
                        ...
                        <Form.Control type="text" placeholder='Enter Name' name='name' value={formik.values.name} onBlur={formik.handleBlur} onChange={formik.handleChange} />
                        {formik.errors.name && formik.touched.name && (<div className='alert alert-danger mt-4 mb-4 p-3'><strong>{formik.errors.name}</strong></div>)}
                    </Form.Group>
                    ...
                    <Form.Group className='mb-3' controlId='Age'>
                        ...
                        <Form.Control type="text" placeholder='Age' name='age' value={formik.values.age} onBlur={formik.handleBlur} onChange={formik.handleChange} />
                        {formik.errors.age && formik.touched.age && (<div className='alert alert-danger mt-4 mb-4 p-3'><strong>{formik.errors.age}</strong></div>)}
                    </Form.Group>
                    <Form.Group className='mb-3' controlId='Phone'>
                        <Form.Label>Phone</Form.Label>
                        <Form.Control type="tel" placeholder='Phone Number' name='phone' value={formik.values.phone} onBlur={formik.handleBlur} onChange={formik.handleChange} />
                        {formik.errors.phone && formik.touched.phone && (<div className='alert alert-danger mt-4 mb-4 p-3'><strong>{formik.errors.phone}</strong></div>)}
                    </Form.Group>
                    <Button variant='primary' type='submit'>{isLoading ? <FaSpinner className="spinner mx-auto" /> : "Register"}</Button>
